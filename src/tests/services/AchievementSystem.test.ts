...
describe('AchievementSystemService', () => {
  ...
  describe('User Achievement Management', () => {
    it('should load user achievements from Firestore', async () => {
      const mockAchievements = [
        { id: '1', userId: 'test-user-id', badgeId: 'badge-1', isCompleted: true },
        { id: '2', userId: 'test-user-id', badgeId: 'badge-2', isCompleted: false },
      ];
  ...
  describe('Notifications', () => {
    ...
    it('should mark notification as read', async () => {
      ...
      expect(mockFirestore().collection().doc().update).toHaveBeenCalledWith({ isRead: true });
    });
  });
  ...
  describe('Sharing', () => {
    ...
    it('should throw error when sharing non-existent achievement', async () => {
      await expect(achievementService.shareAchievement('non-existent-id'))
  ...
  describe('Error Handling', () => {
    it('should handle Firestore errors gracefully', async () => {
      mockFirestore().collection().where().orderBy().get.mockRejectedValue(
