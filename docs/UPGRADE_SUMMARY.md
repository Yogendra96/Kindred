...
Kindred has been upgraded to **React Native 0.82** with the **New Architecture** (Fabric +
TurboModules) fully enabled!
...
A: Your code is already compatible! The New Architecture is mostly transparent to your JavaScript
code.
...
A: Check build logs for "New Architecture enabled" and use your `EnhancedPerformanceService`
metrics.
